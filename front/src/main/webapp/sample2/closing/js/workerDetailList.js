var base = {
	...
	init:function(){
		...
		base.columns = [{
				...
				title:"구분",id:"type_name",
				grid:{width:150, align:"center", sortable:true},
				excel:{width:200},
				search:{id:"type",width:150,type:"select",data:common.getCommonCode,dataParam:{"type":"closing_worker_status"}}
			},{
		...
		list.set(base.columns,{excel:{api:"pop/closingWorker/detailRead",fileName:main.nowMenu.name}});
		base.load();
	},
	load:function(){
		var param = {
